...
use App\Services\Recruitment\ApplicationCsvImportSessionStore;
...
class ApplicationImportController extends Controller
{
    public function __construct(
        private readonly GravityFormsCsvImportService $importService,
        private readonly ApplicationCsvImportSessionStore $sessionStore,
    ) {}
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $diskPath = $validated['file']->store('imports/applications', 'local');
